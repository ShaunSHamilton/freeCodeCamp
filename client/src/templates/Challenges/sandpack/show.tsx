...
import DesktopLayout from '../classic/desktop-layout';
...
function ShowSandpack({
  ...
  const renderEditor = () => {
    ...
    return (
      ...
      <SandpackProvider files={files} theme={freeCodeCampDark} template='react'>
        <SandpackLayout>
          <SandpackFileExplorer />
    ...
    >
      <LearnLayout>
        ...
        <DesktopLayout
          ...
          testOutput={<Output defaultOutput={defaultOutput} output={output} />}
